...
6. Run `local-board estimate` to record both the estimate and the basis: `local-board --root <worktreePath> estimate <ticket-id> <points> --basis <basis-id-or-bootstrap>`.
